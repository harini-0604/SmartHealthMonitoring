...
def run_multi_person_fall_detection():
    ...
    print("MULTI-PERSON FALL DETECTION")
    print("YOLO TRACKING + MEDIAPIPE POSE")
    print("=" * 70)
    ...
    try:
        ...
        while True:
            ...
            cv2.imshow(
                ...
                "Smart Health Monitoring - Multi-Person Fall Detection",
    ...
    print()
    print("=" * 70)
    print("MULTI-PERSON FALL DETECTION STOPPED")
    print("=" * 70)
...
if __name__ == "__main__":
    ...
    run_multi_person_fall_detection()